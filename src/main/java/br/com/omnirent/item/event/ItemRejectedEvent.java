...
public record ItemRejectedEvent(
		...
		String actorId,
		String entityId,
		ItemRejectedAuditSnapshot currentBody,
		ItemRejectedAuditSnapshot previousBody,
		Instant occurredAt
		) implements IntegrationEvent, DomainEvent, AuditableEvent<ItemRejectedAuditSnapshot> {}
